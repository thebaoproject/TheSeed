...
import ga.baoproject.theseed.api.types.SeedRarity;
...
public class VanillaItem extends SeedWeapon {
    ...
    public VanillaItem(Material baseItem) {
        ...
        if (name.contains("diamond")) {
            ...
            if (iw) {
                setRarity(SeedRarity.RARE_WEAPON);
            } else {
                setRarity(SeedRarity.RARE);
            }
            ...
            switch (name) {
                case "dragon egg":
                    setRarity(SeedRarity.LEGENDARY);
                    break;
                case "elytra":
                    setRarity(SeedRarity.RARE);
                    break;
            ...
            if (iw) {
                setRarity(SeedRarity.COMMON_WEAPON);
            } else {
                setRarity(SeedRarity.COMMON);
            }
        }
    }
    ...
    public void attackAction(@NotNull EntityDamageByEntityEvent e) {
        ...
        try {
            ...
            SeedLogger.debug("Received InvalidEntityData when using a vanilla item to attack.");
        }
    }
